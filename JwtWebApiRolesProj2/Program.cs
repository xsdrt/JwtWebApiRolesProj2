global using JwtWebApiRolesProj2.Services.UserService;
...
builder.Services.AddScoped<IUserService, UserService>();//Registered the UserService folder as a scoped service...
builder.Services.AddHttpContextAccessor();//With this, we have the option to inject the IHttpContextAccessor Service (.net6)...
